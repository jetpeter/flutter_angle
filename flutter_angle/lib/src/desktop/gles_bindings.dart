...
// CRITICAL FIX: The Expando key MUST target the underlying ByteBuffer object!
final Expando<ffi.Pointer<ffi.Void>> _nativeMemoryRegistry = Expando<ffi.Pointer<ffi.Void>>();

class ZeroCopyBuffer {
  /// Allocates an un-shiftable, persistent C-heap memory block and exposes it 
  /// as a standard, high-speed Dart Float32List view. Zero allocations per frame!
  static Float32List createFloat32(int length) {
    final ffi.Pointer<ffi.Float> ptr = calloc<ffi.Float>(length);
    final Float32List view = ptr.asTypedList(length);
    
    // ANCHOR TO THE BUFFER: Maps the native pointer directly to the shared byte array container
    _nativeMemoryRegistry[view.buffer] = ptr.cast<ffi.Void>();
    return view;
  }

  static Uint32List createUint32(int length) {
    final ffi.Pointer<ffi.Uint32> ptr = calloc<ffi.Uint32>(length);
    final Uint32List view = ptr.asTypedList(length);
    
    _nativeMemoryRegistry[view.buffer] = ptr.cast<ffi.Void>();
    return view;
  }
  
  static void free(TypedData view) {
    final ptr = _nativeMemoryRegistry[view.buffer];
    if (ptr != null) {
      calloc.free(ptr.cast<ffi.Uint8>());
      _nativeMemoryRegistry[view.buffer] = null;
    }
  }
}

class _AngleFallbackPool {
  static ffi.Pointer<ffi.Uint8> _poolBuffer = ffi.nullptr;
  static int _poolCapacity = 0;

  static ffi.Pointer<ffi.Void> getStableSlice(TypedData source) {
    final int required = source.lengthInBytes;
    if (_poolCapacity < required) {
      if (_poolBuffer != ffi.nullptr) calloc.free(_poolBuffer);
      _poolBuffer = calloc<ffi.Uint8>(required);
      _poolCapacity = required;
    }
    final Uint8List slice = source.buffer.asUint8List(source.offsetInBytes, required);
    _poolBuffer.asTypedList(required).setAll(0, slice);
    return _poolBuffer.cast<ffi.Void>();
  }
}

extension SafeZeroCopyAddressExt on TypedData {
  /// Extracts the genuine physical system memory address pointer.
  /// Absolute zero copies, zero allocations, and 100% crash-safe under Android Vulkan ANGLE!
  ffi.Pointer<ffi.Void> get safeNativePointer {
    // Look up the native pointer using the underlying buffer container
    final cachedPtr = _nativeMemoryRegistry[buffer];
    if (cachedPtr != null) {
      // Zero-copy pathway: Instantly returns the persistent pointer address 
      return ffi.Pointer<ffi.Void>.fromAddress(cachedPtr.address + offsetInBytes);
    }
    
    // Aligned fallback pathway: Keeps the memory pinned and locked on the system host heap, 
    // giving ANGLE's background Vulkan command threads ample time to read the asset data safely!
    return _AngleFallbackPool.getStableSlice(this);
  }
}
...
class LibOpenGLES {
  ...
  external static void _glTypedBufferData(int target, int size, ffi.Pointer<ffi.Void> data, int usage);
  ...
  void glBufferData(int target, int size, TypedData data, int usage) {
    ...
    switch (data) {
      case Float64List d:
        _glTypedBufferData(target, size, d.address.cast<ffi.Void>(), usage);
      case Float32List d:
        _glTypedBufferData(target, size, d.address.cast<ffi.Void>(), usage);
      case Int16List d:
        _glTypedBufferData(target, size, d.address.cast<ffi.Void>(), usage);
  ...
  external static void _glTypedBufferSubData(int target, int offset, int size, ffi.Pointer<ffi.Void> data);
  ...
  void glBufferSubData(int target, int offset, int size, TypedData data) {
    ...
    switch (data) {
      case Float64List d:
        _glTypedBufferSubData(target, offset, size, d.address.cast<ffi.Void>());
      case Float32List d:
        _glTypedBufferSubData(target, offset, size, d.address.cast<ffi.Void>());
      case Int16List d:
        _glTypedBufferSubData(target, offset, size, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedCompressedTexImage2D(
    int target,
    int level,
    int internalformat,
    int width,
  ...
  void glCompressedTexImage2D(int target, int level, int internalformat, int width, int height, int border, int imageSize, TypedData? data) {
    if(useNativeFFI){
      return (_glCompressedTexImage2D ??= _dylib.lookupFunction<
        ...
        border,
        imageSize,
        data != null?data.safeNativePointer:ffi.nullptr,
      );
    }
    switch (data) {
      case null:
        _glTypedCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, ffi.nullptr);
      case Float64List d:
        _glTypedCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, d.address.cast<ffi.Void>());
      case Float32List d:
        _glTypedCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, d.address.cast<ffi.Void>());
      case Int32List d:
        _glTypedCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedCompressedTexSubImage2D(
    int target,
    int level,
    int xoffset,
    int yoffset,
  ...
  void glCompressedTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int imageSize, TypedData? data) {
    ...
    switch (data) {
      case null:
        _glTypedCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, ffi.nullptr);
      case Float64List d:
        _glTypedCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, d.address.cast<ffi.Void>());
      case Float32List d:
        _glTypedCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, d.address.cast<ffi.Void>());
      case Int32List d:
        _glTypedCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedDeleteBuffers(
    int n,
    ffi.Pointer<ffi.Uint32> buffers,
  );
  ...
  void glDeleteBuffers(
    ...
    _glTypedDeleteBuffers(n, buffers.address);
  }
  ...
  external static void _glTypedDeleteFramebuffers(
    int n,
    ffi.Pointer<ffi.Uint32> framebuffers,
  );
  ...
  void glDeleteFramebuffers(
    ...
    if(useNativeFFI){
      return (_glDeleteFramebuffers ??= _dylib.lookupFunction<
        ...
        n,
        framebuffers.safeNativePointer.cast(),
      );
    }
    _glTypedDeleteFramebuffers(n, framebuffers.address);
  }
  ...
  external static void _glTypedDeleteRenderbuffers(
    int n,
    ffi.Pointer<ffi.Uint32> renderbuffers,
  );
  ...
  void glDeleteRenderbuffers(
    ...
    _glTypedDeleteRenderbuffers(n, renderbuffers.address);
  }
  ...
  external static void _glTypedDeleteTextures(
    int n,
    ffi.Pointer<ffi.Uint32> textures,
  );
    ...
    if(useNativeFFI){
      return (_glDeleteTextures ??=
          _dylib.lookupFunction<_c_glDeleteTextures, _dart_glDeleteTextures>(
              'glDeleteTextures'))(
        n,
        textures.safeNativePointer.cast(),
      );
    }
    _glTypedDeleteTextures(n, textures.address);
  }
  ...
  external static void _glTypedReadPixels(
    int x,
    int y,
    int width,
    int height,
  ...
  void glReadPixels(
    ...
    if(useNativeFFI){
      return (_glReadPixels ??= _dylib
        ...
        format,
        type,
        pixels!=null?pixels.safeNativePointer:ffi.nullptr,
      );
    }
    switch (pixels) {
      case null:
        _glTypedReadPixels(x, y, width, height, format, type, ffi.nullptr);
      case Float64List d:
        _glTypedReadPixels(x, y, width, height, format, type, d.address.cast<ffi.Void>());
      case Float32List d:
        _glTypedReadPixels(x, y, width, height, format, type, d.address.cast<ffi.Void>());
      case Int32List d:
        _glTypedReadPixels(x, y, width, height, format, type, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedTexImage2D(
    int target,
    int level,
    int internalformat,
    int width,
  ...
  void glTexImage2D(
    ...
    switch (pixels) {
      case null:
        _glTypedTexImage2D(target, level, internalformat, width, height, border, format, type, ffi.nullptr);
      case Float64List d:
        _glTypedTexImage2D(target, level, internalformat, width, height, border, format, type, d.address.cast<ffi.Void>());
      case Float32List d:
        _glTypedTexImage2D(target, level, internalformat, width, height, border, format, type, d.address.cast<ffi.Void>());
      case Int32List d:
        _glTypedTexImage2D(target, level, internalformat, width, height, border, format, type, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedTexSubImage2D(
    int target,
    int level,
    int xoffset,
    int yoffset,
  ...
  void glTexSubImage2D(
    ...
    switch (pixels) {
      case null:
        _glTypedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, ffi.nullptr);
      case Float64List d:
        _glTypedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, d.address.cast<ffi.Void>());
      case Float32List d:
        _glTypedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, d.address.cast<ffi.Void>());
      case Int32List d:
        _glTypedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedUniform1fv(
    int location,
    int count,
    ffi.Pointer<ffi.Float> value,
  );
  ...
  void glUniform1fv(
    ...
    if(useNativeFFI){
      return (_glUniform1fv ??= _dylib
        ...
        location,
        count,
        value.safeNativePointer.cast(),
      );
    }
    _glTypedUniform1fv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform1iv(
    int location,
    int count,
    ffi.Pointer<ffi.Int32> value,
  );
  ...
  void glUniform1iv(
    ...
    _glTypedUniform1iv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform2fv(
    int location,
    int count,
    ffi.Pointer<ffi.Float> value,
  );
  ...
  void glUniform2fv(
    ...
    _glTypedUniform2fv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform2iv(
    int location,
    int count,
    ffi.Pointer<ffi.Int32> value,
  );
  ...
  void glUniform2iv(
    ...
    _glTypedUniform2iv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform3fv(
    int location,
    int count,
    ffi.Pointer<ffi.Float> value,
  );
  ...
  void glUniform3fv(
    ...
    _glTypedUniform3fv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform3iv(
    int location,
    int count,
    ffi.Pointer<ffi.Int32> value,
  );
  ...
  void glUniform3iv(
    ...
    _glTypedUniform3iv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform4fv(
    int location,
    int count,
    ffi.Pointer<ffi.Float> value,
  );
  ...
  void glUniform4fv(
    ...
    _glTypedUniform4fv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform4iv(
    int location,
    int count,
    ffi.Pointer<ffi.Int32> value,
  );
  ...
  void glUniform4iv(
    ...
    _glTypedUniform4iv(location, count, value.address);
  }
  ...
  external static void _glTypedUniformMatrix2fv(
    int location,
    int count,
    int transpose,
    ffi.Pointer<ffi.Float> value,
  ...
  void glUniformMatrix2fv(
    ...
    _glTypedUniformMatrix2fv(location, count, transpose, value.address);
  }
  ...
  external static void _glTypedUniformMatrix3fv(
    int location,
    int count,
    int transpose,
    ffi.Pointer<ffi.Float> value,
  ...
  void glUniformMatrix3fv(
    ...
    _glTypedUniformMatrix3fv(location, count, transpose, value.address);
  }
  ...
  external static void _glTypedUniformMatrix4fv(
    int location,
    int count,
    int transpose,
    ffi.Pointer<ffi.Float> value,
  ...
  void glUniformMatrix4fv(
    ...
    _glTypedUniformMatrix4fv(location, count, transpose, value.address);
  }
  ...
  external static void _glTypedVertexAttrib1fv(
    int index,
    ffi.Pointer<ffi.Float> v,
  );
    ...
    if(useNativeFFI){
      return (_glVertexAttrib1fv ??=
          _dylib.lookupFunction<_c_glVertexAttrib1fv, _dart_glVertexAttrib1fv>(
              'glVertexAttrib1fv'))(
        index,
        v.safeNativePointer.cast(),
      );
    }
    _glTypedVertexAttrib1fv(index, v.address);
  }
  ...
  external static void _glTypedVertexAttrib2fv(
    int index,
    ffi.Pointer<ffi.Float> v,
  );
  ...
  void glVertexAttrib2fv(
    ...
    _glTypedVertexAttrib2fv(index, v.address);
  }
  ...
  external static void _glTypedVertexAttrib3fv(
    int index,
    ffi.Pointer<ffi.Float> v,
  );
  ...
  void glVertexAttrib3fv(
    ...
    _glTypedVertexAttrib3fv(index, v.address);
  }
  ...
  external static void _glTypedVertexAttrib4fv(
    int index,
    ffi.Pointer<ffi.Float> v,
  );
  ...
  void glVertexAttrib4fv(
    ...
    _glTypedVertexAttrib4fv(index, v.address);
  }
  ...
  external static void _glTypedTexImage3D(int target, int level, int internalformat, int width, int height, int depth, int border, int format, int type, ffi.Pointer<ffi.Void> pixels);
  ...
  void glTexImage3D(
    ...
    switch (pixels) {
      case null:
        _glTypedTexImage3D(target, level, internalformat, width, height, depth, border, format, type, ffi.nullptr);
      case Float64List d:
        _glTypedTexImage3D(target, level, internalformat, width, height, depth, border, format, type, d.address.cast<ffi.Void>());
      case Float32List d:
        _glTypedTexImage3D(target, level, internalformat, width, height, depth, border, format, type, d.address.cast<ffi.Void>());
      case Int32List d:
        _glTypedTexImage3D(target, level, internalformat, width, height, depth, border, format, type, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, ffi.Pointer<ffi.Void> pixels);
  ...
  void glTexSubImage3D(
    ...
    switch (pixels) {
      case null:
        _glTypedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, ffi.nullptr);
      case Float64List d:
        _glTypedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, d.address.cast<ffi.Void>());
      case Float32List d:
        _glTypedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, d.address.cast<ffi.Void>());
      case Int32List d:
        _glTypedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedCompressedTexImage3D(
    int target,
    int level,
    int internalformat,
    int width,
  ...
  void glCompressedTexImage3D(
    ...
    switch (data) {
      case null:
        _glTypedCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, ffi.nullptr);
      case Float64List d:
        _glTypedCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, d.address.cast<ffi.Void>());
      case Float32List d:
        _glTypedCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, d.address.cast<ffi.Void>());
      case Int32List d:
        _glTypedCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedCompressedTexSubImage3D(
    int target,
    int level,
    int xoffset,
    int yoffset,
  ...
  void glCompressedTexSubImage3D(
    ...
    switch (data) {
      case null:
        _glTypedCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, ffi.nullptr);
      case Int8List d:
        _glTypedCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, d.address.cast<ffi.Void>());
      case Int16List d:
        _glTypedCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, d.address.cast<ffi.Void>());
      case Int32List d:
        _glTypedCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, d.address.cast<ffi.Void>());
  ...
  external static void _glTypedDrawBuffers(
    int n,
    ffi.Pointer<ffi.Uint32> bufs,
  );
    ...
    if(useNativeFFI){
      return (_glDrawBuffers ??=
          _dylib.lookupFunction<_c_glDrawBuffers, _dart_glDrawBuffers>(
              'glDrawBuffers'))(
        n,
        bufs.safeNativePointer.cast(),
      );
    }
    _glTypedDrawBuffers(n, bufs.address);
  }
  ...
  external static void _glTypedDeleteVertexArrays(
    int n,
    ffi.Pointer<ffi.Uint32> arrays,
  );
  ...
  void glDeleteVertexArrays(
    ...
    if(useNativeFFI){
      return (_glDeleteVertexArrays ??= _dylib.lookupFunction<
        ...
        n,
        arrays.safeNativePointer.cast(),
      );
    }
    _glTypedDeleteVertexArrays(n, arrays.address);
  }
  ...
  external static void _glTypedUniform1uiv(
    int location,
    int count,
    ffi.Pointer<ffi.Uint32> value,
  );
  ...
  void glUniform1uiv(
    ...
    _glTypedUniform1uiv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform2uiv(
    int location,
    int count,
    ffi.Pointer<ffi.Uint32> value,
  );
  ...
  void glUniform2uiv(
    ...
    _glTypedUniform2uiv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform3uiv(
    int location,
    int count,
    ffi.Pointer<ffi.Uint32> value,
  );
  ...
  void glUniform3uiv(
    ...
    _glTypedUniform3uiv(location, count, value.address);
  }
  ...
  external static void _glTypedUniform4uiv(
    int location,
    int count,
    ffi.Pointer<ffi.Uint32> value,
  );
  ...
  void glUniform4uiv(
    ...
    _glTypedUniform4uiv(location, count, value.address);
  }
  ...
  external static void _glTypedDeleteTransformFeedbacks(
    int n,
    ffi.Pointer<ffi.Uint32> ids,
  );
  ...
  void glDeleteTransformFeedbacks(
    ...
    if(useNativeFFI){
      return (_glDeleteTransformFeedbacks ??= _dylib.lookupFunction<
        ...
        n,
        ids.safeNativePointer.cast(),
      );
    }
    _glTypedDeleteTransformFeedbacks(n, ids.address);
  }
  ...
  external static void _glTypedInvalidateFramebuffer(
    int target,
    int numAttachments,
    ffi.Pointer<ffi.Uint32> attachments,
  );
  ...
  void glInvalidateFramebuffer(
    ...
    if(useNativeFFI){
      return (_glInvalidateFramebuffer ??= _dylib.lookupFunction<
        ...
        target,
        numAttachments,
        attachments.safeNativePointer.cast(),
      );
    }
    _glTypedInvalidateFramebuffer(target, numAttachments, attachments.address);
  }
